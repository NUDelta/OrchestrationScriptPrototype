...
export default function Scaffolding() {
    return (
      <div>
        ...
        <label style={{fontSize: "15px"}}>Step2: After you noticed this situation, how did you support your student in practicing a more effective working or learning strategy?<br/>In an ideal world, what are some ways you would have supported them to implement the effective strategy across the venues/tools/processes in the DTR network?</label>
        <textarea style={{ height: "10vh", width: "100%", fontSize: "15px", marginBottom: 16, marginTop: 10, resize: "vertical" }}></textarea>

        <label style={{fontSize: "15px"}}>Step3: Restate more concisely the <br/>1) the ineffective working or learning strategy you are trying to detect and <br/>2) ways you would like to support the student to implement the effective strategy across the venues/tools/processes in the DTR network?</label>
