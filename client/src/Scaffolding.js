...
export default function Scaffolding() {
    return (
      <div>
        ...
        <br/>In an ideal world, please list 2 or more ways you would have supported them to implement the effective strategy by getting support from appropriate venues/tools/people/processes in the DTR network? 
        </label>
